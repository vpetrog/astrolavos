...
constexpr const char* _GPS_VERSION = "1.1.0"; // software version of this library
constexpr double _GPS_MPH_PER_KNOT  = 1.15077945;
constexpr double _GPS_MPS_PER_KNOT = 0.51444444;
constexpr double _GPS_KMPH_PER_KNOT = 1.852;
constexpr double _GPS_MILES_PER_METER = 0.00062137112;
constexpr double _GPS_KM_PER_METER = 0.001;
constexpr double _GPS_FEET_PER_METER = 3.2808399;
constexpr uint8_t _GPS_MAX_FIELD_SIZE = 15;
constexpr uint32_t _GPS_EARTH_MEAN_RADIUS = 6371009; // old: 6372795
