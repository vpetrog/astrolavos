// Copied from https://github.com/IanBurwell/DynamicLRS/blob/c26f7f8dcca0c1b70af0aa6aee3aba3a1652aba6/components/DLRS_LoRadio/radiolib_esp32s3_hal.hpp
...
class EspHal : public RadioLibHal {
 public:
  ...
  void spiBegin() {
    ...
    ESP_ERROR_CHECK(spi_bus_initialize(this->host, &buscfg, SPI_DMA_CH_AUTO));
